        ...
        <div id="gallary">
            ...
            <div class="card-deck">
                ...
                <div class="card" data-aos="zoom-in">
                        ...
                        <img src=".." class="card-img-top" alt="..." style="height: 23rem;">
                        <div class="card-body">
                            <div class="title">phone pe  </div>
                        <div class="card-text">
                            phone pe details
                        </div>
                ...
                <div class="card" data-aos="zoom-in">
                        ...
                        <img src=".." class="card-img-top" alt="..." style="height: 23rem;">
                        <div class="card-body">
                            <div class="title"> account transfer </div>

                        <div class="card-text">
                        Name of the Bank - STATE BANK OF INDIA<br>
                        Account Holder's Name - SATYAJEET MAHATO<br>
                        Account Number - 34643305851<br>
                    IFSC Code - SBIN0004770<br>
                        </div>
                        <div class="card-footer">
                            <small class="text-muted">extra</small>
                        </div>
