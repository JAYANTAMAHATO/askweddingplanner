      ...
      <div class="card-deck">
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=4";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=5";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=6";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
      ...
      <div class="card-deck">
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=7";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=8";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
        ...
        <div class="card " data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=9";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
      ...
      <div class="card-deck">
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=10";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=11";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
        ...
        <div class="card" data-aos="zoom-in">
          <?php
                ...
                include "../php/connection.php";
                 $query="SELECT * FROM `project` WHERE id=12";
                 $run=mysqli_query($conn, $query);
                 $_SESSION= mysqli_fetch_assoc( $run );
